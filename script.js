// --- SECURITY: PROTECT CSS & JS FROM THEFT ---
...
(function() {
    ...
    if (devToolsOpen()) {
        ...
        alert('⚠️ Developer Tools access is restricted on this website.');
        window.location.href = 'about:blank';
    }

    // Listen for DevTools being opened
    window.addEventListener('resize', () => {
        if (devToolsOpen()) {
            document.body.innerHTML = '';
            alert('⚠️ Do not inspect or modify source code. Developer Tools are disabled.');
            window.location.href = 'about:blank';
        }
    });
...
// Prevent CSS & JS file access
if (document.querySelector('link[rel="stylesheet"][href="styles.css"]')) {
    Object.defineProperty(document.querySelector('link[rel="stylesheet"][href="styles.css"]'), 'href', {
        get: () => '',
        set: () => {}
    });
}
...
// Protect script tags from being copied
...
// Disable page source viewing (console)
